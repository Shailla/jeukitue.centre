...
insert into ROLE (ROL_NAME, PRF_NAME) VALUES ("Administrateur",		"ROLE_ADMIN");
insert into ROLE (ROL_NAME, PRF_NAME) VALUES ("Administrateur",		"ROLE_USER");
insert into ROLE (ROL_NAME, PRF_NAME) VALUES ("Utilisateur",		"ROLE_USER");
