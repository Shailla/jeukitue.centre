...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_5__authentication_service__["a" /* AuthenticationService */], __WEBPACK_IMPORTED_MODULE_6__user_service__["a" /* UserService */]],
...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        ...
        return this.http.post(this.authServiceBaseUrl + 'login', { headers: headers }).pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["a" /* catchError */])(this.handleError));
    };
    AuthenticationService.prototype.logout = function () {
        return this.http.post(this.authServiceBaseUrl + 'logout', {}).pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["a" /* catchError */])(this.handleError));
    };
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function () {
        this.authenticationService.login(this.username, this.password).subscribe(function (user) { return console.log(user); });
        this.username = '';
        this.password = '';
    };
...
var UserService = (function () {
    function UserService(http) {
        this.http = http;
        this.userServiceBaseUrl = '/admin/user/'; // Services about users (create, remove, update, change password, ...)
    }
    UserService.prototype.getUsers = function () {
        console.log('coucou 1');
        return this.http.get(this.userServiceBaseUrl)
    ...
    UserService.prototype.getUser = function (login) {
        return this.http.get(this.userServiceBaseUrl + '/' + login)
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["a" /* catchError */])(this.handleError));
    };
...
module.exports = "<h1>Page de gestion des utilisateurs</h1>\r\n\r\n<!-- Liste des utilisateurs -->\r\n<table>\r\n\t<thead>\r\n\t\t<tr>\r\n\t\t\t<th>ID</th>\r\n\t\t\t<th>Login</th>\r\n\t\t\t<th>Mail</th>\r\n\t\t</tr>\r\n\t</thead>\r\n\t<tbody>\r\n\t\t<tr *ngFor=\"let user of users\" (click)=\"onSelect(user.login)\" [class.selected]=\"user == selectedUser\">\r\n\t\t\t<td>{{user.login}}</td>\r\n\t\t\t<td>{{user.mail}}</td>\r\n\t\t\t<td>{{user.enabled}}</td>\r\n\t\t</tr>\r\n\t</tbody>\r\n</table>\r\n\r\n<!-- Modification d'un utilisateur -->\r\n<div *ngIf=\"selectedUser\">\r\n  <h2>{{selectedUser.login}}</h2>\r\n  <div>\r\n    <label>Mail:\r\n      <input [(ngModel)]=\"selectedUser.mail\" placeholder=\"mail\">\r\n    </label>\r\n    <label>Enabled:\r\n      <input [(ngModel)]=\"selectedUser.enabled\" placeholder=\"enabled\">\r\n    </label>\r\n  </div>\r\n</div>"
...
var UsersComponent = (function () {
    ...
    UsersComponent.prototype.onSelect = function (userLogin) {
        var _this = this;
        console.log('User selected : ', userLogin);
        this.userService.getUser(userLogin).subscribe(function (user) { return _this.selectedUser = user; });
    };
